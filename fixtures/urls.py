...
from .views import generate_fixture_view, fixture_list, current_fixtures, schedule_round, delete_fixtures, my_fixtures, bulk_schedule
...
urlpatterns = [
    ...
    path("fixtures/<int:season_id>/round/<int:round_number>/schedule/", schedule_round, name="schedule_round"),
    # path("fixtures/my-team/", my_fixtures, name="my_fixtures"),
    ...
    path("fixtures/generate/<int:season_id>/", generate_fixture_view, name="generate_fixtures"),
    path("fixtures/delete/<int:season_id>/", delete_fixtures, name="delete_fixtures"),
    path("fixtures/<int:season_id>/bulk-schedule/", bulk_schedule, name="bulk_schedule"),
    # path(
